...
SELECT
	...
	(SELECT TOP 1 X.PAAVERBAL FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PAA_VERBAL,
	(SELECT TOP 1 X.PAAMATEMAT FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PAA_MATEMATICAS,
	(SELECT TOP 1 X.PAAHISGEO FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PAA_HISTORIA_GEO,
	(SELECT TOP 1 X.PSUVERVAL FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PSU_VERBAL,
	(SELECT TOP 1 X.PSUMATEMAT FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PSU_MATEMATICAS,
	(SELECT TOP 1 X.PSUHISGEO FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) PSU_HISTORIA_GEO,
	(SELECT TOP 1 X.TIPOPRUEBA FROM UNIACC.DBO.MT_PAA X WHERE X.CODCLI=A.RUT ORDER BY X.FECMOD DESC) TIPO_PRUEBA,
